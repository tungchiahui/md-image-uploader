...
The project currently contains the extension scaffold and resource-scoped configuration system. Image conversion, uploads, and paste handling will be added in later tasks from the project specification.
